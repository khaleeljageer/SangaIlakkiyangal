...
class FileDownloaderImpl @Inject constructor(
    ...
    override suspend fun downloadFile(
        ...
        Log.d("FileDownloaderImpl", "Downloading file from URL: $url")
        ...
        val destinationDir = File(context.filesDir, "downloads")
        if (!destinationDir.exists()) {
            destinationDir.mkdirs()
        }
        val destinationFile = File(destinationDir, "${uniqueId}.pdf")
